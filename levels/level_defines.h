...
DEFINE_LEVEL("CASTLE",         LEVEL_TEST_CASTLE,      COURSE_BOB,      castle,           generic,  15000,    0x08, 0x08, 0x08, _,         _)
DEFINE_LEVEL("TEST",           LEVEL_TEST,             COURSE_BOB,      test,             generic,  15000,    0x08, 0x08, 0x08, _,         _)
DEFINE_LEVEL("DONJON",         LEVEL_DONJON,           COURSE_BOB,      donjon,           generic,  15000,    0x08, 0x08, 0x08, _,         _)
