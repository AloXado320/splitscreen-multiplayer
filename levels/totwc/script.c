...
static const LevelScript script_func_local_1[] = {
    ...
    //OBJECT(/*model*/ MODEL_NONE,       /*pos*/ -1019, -1897, 10, /*angle*/ 0, 0, 0, /*behParam*/ 0x00340000, /*beh*/ bhvBetaTrampolineTop), //MUST be placed 150 units above the ground for it to work proper.
    RETURN(),
};
