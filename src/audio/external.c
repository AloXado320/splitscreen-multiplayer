    ...
    while (conditionBits & 0xff00) {
        ...
        for (j = 0; j < condIndex; j++) {
            switch (conditionTypes[j]) {
                case MARIO_X_GE: {
                    if (((s16) gMarioStates[0].pos[0] + gMarioStates[1].pos[0] / 2)
                        < conditionValues[j])
                        j = condIndex + 1;
                    break;
                }
                case MARIO_Y_GE: {
                    if (((s16) gMarioStates[0].pos[1] + gMarioStates[1].pos[1] / 2)
                        < conditionValues[j])
                        j = condIndex + 1;
                    break;
                }
                case MARIO_Z_GE: {
                    if (((s16) gMarioStates[0].pos[2] + gMarioStates[1].pos[2] / 2)
                        < conditionValues[j])
                        j = condIndex + 1;
                    break;
                }
