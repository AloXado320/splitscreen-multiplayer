...
static s16 verts_luigi_eye_right[VTX_NUM][3] = {{307, 18, 77}, {319, 10, 75}, {312, -17, 89}, {309, 33, 47}, {321, 25, 44}, {310, 37, 5}, {321, 29, 2}, {317, 22, -36}, {306, 30, -33}, {312, 4, -64}, {300, 12, -61}, {305, -24, -72}, {287, -46, -57}, {299, -54, -59}, {284, -63, -26}, {296, -71, -29}, {285, -67, 14}, {298, -74, 11}, {300, -67, 51}, {288, -59, 54}, {304, -48, 80}, {293, -41, 83}, {315, -38, 7}, {316, -36, 15}, {317, -31, 19}, {294, -17, -70}, {316, -21, 61}, {312, -39, 55}, {309, -51, 38}, {307, -54, -20}, {308, -44, -39}, {311, -26, -47}, {316, -7, -42}, {320, 2, -24}, {323, 5, 33}, {320, -4, 53}, {318, -24, 23}, {307, -57, 9}, {315, -37, -2}, {315, -33, -6}, {316, -26, -10}, {318, -19, -7}, {319, -14, -4}, {323, 8, 3}, {320, -13, 14}, {319, -18, 18}, {320, -12, 4}, {301, -10, 91}};


/* @ 04003730 */
static struct GdVtxData vtx_luigi_eye_right = { VTX_NUM, 0x1, verts_luigi_eye_right };
#undef VTX_NUM

#define FACE_NUM 82
/* @ 0400373C */
static u16 facedata_luigi_eye_right[FACE_NUM][4] = {{1, 2, 1, 0}, {1, 1, 4, 3}, {1, 4, 6, 5}, {1, 6, 7, 5}, {1, 7, 9, 8}, {1, 9, 11, 10}, {1, 11, 13, 12}, {1, 13, 15, 14}, {1, 15, 17, 16}, {1, 17, 18, 16}, {1, 18, 20, 19}, {1, 20, 2, 21}, {1, 0, 47, 2}, {1, 2, 26, 1}, {1, 20, 26, 2}, {1, 18, 27, 20}, {1, 17, 28, 18}, {1, 15, 29, 17}, {1, 13, 30, 15}, {1, 11, 31, 13}, {1, 9, 31, 11}, {1, 7, 32, 9}, {1, 6, 33, 7}, {1, 4, 34, 6}, {1, 1, 35, 4}, {1, 35, 34, 4}, {1, 34, 43, 6}, {1, 6, 43, 33}, {1, 7, 33, 32}, {1, 9, 32, 31}, {1, 31, 30, 13}, {1, 30, 29, 15}, {1, 29, 37, 17}, {1, 17, 37, 28}, {1, 18, 28, 27}, {1, 20, 27, 26}, {1, 26, 35, 1}, {1, 3, 0, 1}, {1, 5, 3, 4}, {1, 7, 8, 5}, {1, 9, 10, 8}, {1, 11, 25, 10}, {1, 12, 25, 11}, {1, 14, 12, 13}, {1, 16, 14, 15}, {1, 18, 19, 16}, {1, 2, 47, 21}, {1, 20, 21, 19}, {2, 26, 36, 35}, {2, 27, 36, 26}, {2, 28, 24, 27}, {2, 37, 23, 28}, {2, 29, 38, 37}, {2, 30, 39, 29}, {2, 31, 40, 30}, {2, 32, 40, 31}, {2, 33, 41, 32}, {2, 43, 42, 33}, {2, 34, 44, 43}, {2, 35, 45, 34}, {2, 45, 44, 34}, {2, 44, 46, 43}, {2, 43, 46, 42}, {2, 33, 42, 41}, {2, 32, 41, 40}, {2, 40, 39, 30}, {2, 39, 38, 29}, {2, 38, 22, 37}, {2, 37, 22, 23}, {2, 28, 23, 24}, {2, 27, 24, 36}, {2, 36, 45, 35}, {3, 24, 23, 22}, {3, 22, 36, 24}, {3, 22, 38, 36}, {3, 38, 39, 36}, {3, 39, 40, 36}, {3, 40, 41, 36}, {3, 41, 45, 36}, {3, 41, 42, 45}, {3, 42, 46, 45}, {3, 46, 44, 45}};


/* @ 040039CC */
static struct GdFaceData faces_luigi_eye_right = { FACE_NUM, 0x1, facedata_luigi_eye_right };
#undef FACE_NUM

/* @ 040039D8 */
struct DynList dynlist_luigi_eye_right[28] = {
    BeginList(),
    MakeDynObj(D_DATA_GRP, 0x71),
    LinkWithPtr(&vtx_luigi_eye_right),
    MakeDynObj(D_DATA_GRP, 0x72),
    LinkWithPtr(&faces_luigi_eye_right),
    StartGroup(0x73),
...
#define VTX_NUM 48
/* @ 04003C78 */
static s16 verts_luigi_eye_left[VTX_NUM][3] = {{301, 23, -76}, {316, 17, -75}, {311, -11, -94}, {303, 36, -42}, {318, 29, -41}, {302, 35, -1}, {316, 28, 0}, {311, 16, 38}, {297, 23, 36}, {305, -5, 62}, {291, 1, 61}, {298, -36, 65}, {280, -58, 44}, {294, -64, 46}, {279, -71, 10}, {294, -78, 12}, {282, -70, -30}, {296, -78, -28}, {300, -65, -66}, {286, -58, -68}, {305, -43, -91}, {291, -35, -93}, {314, -39, -16}, {315, -37, -24}, {316, -32, -28}, {285, -29, 63}, {316, -16, -67}, {312, -36, -66}, {310, -50, -50}, {305, -60, 6}, {305, -51, 28}, {307, -33, 40}, {311, -15, 38}, {316, -2, 22}, {321, 7, -34}, {319, 0, -56}, {318, -24, -30}, {307, -59, -21}, {313, -39, -6}, {314, -36, -1}, {315, -29, 4}, {316, -22, 1}, {318, -17, -1}, {320, 6, -3}, {319, -14, -18}, {319, -17, -23}, {319, -14, -9}, {297, -4, -95}};


/* @ 04003D98 */
static struct GdVtxData vtx_luigi_eye_left = { VTX_NUM, 0x1, verts_luigi_eye_left };
#undef VTX_NUM

#define FACE_NUM 82
/* @ 04003DA4 */
static u16 facedata_luigi_eye_left[FACE_NUM][4] = {{1, 0, 1, 2}, {1, 3, 4, 1}, {1, 5, 6, 4}, {1, 5, 7, 6}, {1, 8, 9, 7}, {1, 10, 11, 9}, {1, 12, 13, 11}, {1, 14, 15, 13}, {1, 16, 17, 15}, {1, 16, 18, 17}, {1, 19, 20, 18}, {1, 21, 2, 20}, {1, 2, 47, 0}, {1, 1, 26, 2}, {1, 2, 26, 20}, {1, 20, 27, 18}, {1, 18, 28, 17}, {1, 17, 29, 15}, {1, 15, 30, 13}, {1, 13, 31, 11}, {1, 11, 31, 9}, {1, 9, 32, 7}, {1, 7, 33, 6}, {1, 6, 34, 4}, {1, 4, 35, 1}, {1, 4, 34, 35}, {1, 6, 43, 34}, {1, 33, 43, 6}, {1, 32, 33, 7}, {1, 31, 32, 9}, {1, 13, 30, 31}, {1, 15, 29, 30}, {1, 17, 37, 29}, {1, 28, 37, 17}, {1, 27, 28, 18}, {1, 26, 27, 20}, {1, 1, 35, 26}, {1, 1, 0, 3}, {1, 4, 3, 5}, {1, 5, 8, 7}, {1, 8, 10, 9}, {1, 10, 25, 11}, {1, 11, 25, 12}, {1, 13, 12, 14}, {1, 15, 14, 16}, {1, 16, 19, 18}, {1, 21, 47, 2}, {1, 19, 21, 20}, {2, 35, 36, 26}, {2, 26, 36, 27}, {2, 27, 24, 28}, {2, 28, 23, 37}, {2, 37, 38, 29}, {2, 29, 39, 30}, {2, 30, 40, 31}, {2, 31, 40, 32}, {2, 32, 41, 33}, {2, 33, 42, 43}, {2, 43, 44, 34}, {2, 34, 45, 35}, {2, 34, 44, 45}, {2, 43, 46, 44}, {2, 42, 46, 43}, {2, 41, 42, 33}, {2, 40, 41, 32}, {2, 30, 39, 40}, {2, 29, 38, 39}, {2, 37, 22, 38}, {2, 23, 22, 37}, {2, 24, 23, 28}, {2, 36, 24, 27}, {2, 35, 45, 36}, {3, 22, 23, 24}, {3, 24, 36, 22}, {3, 36, 38, 22}, {3, 36, 39, 38}, {3, 36, 40, 39}, {3, 36, 41, 40}, {3, 36, 45, 41}, {3, 45, 42, 41}, {3, 45, 46, 42}, {3, 45, 44, 46}};


/* @ 04004034 */
static struct GdFaceData faces_luigi_eye_left = { FACE_NUM, 0x1, facedata_luigi_eye_left };
#undef FACE_NUM

/* @ 04004040 */
struct DynList dynlist_luigi_eye_left[28] = {
    BeginList(),
    MakeDynObj(D_DATA_GRP, 0x61),
    LinkWithPtr(&vtx_luigi_eye_left),
    MakeDynObj(D_DATA_GRP, 0x62),
    LinkWithPtr(&faces_luigi_eye_left),
    StartGroup(0x63),
    MakeDynObj(D_MATERIAL, 0x0),
    SetId(0),
    SetAmbient(0.0, 0.291, 1.0),
