COURSE_ACTS(COURSE_BOB, _(" 1 BOB-OMB BATTLEFIELD"),
       ...
       _("FIND THE 8 RED COINS")          , _("THE BROS. WING TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_HMC, _(" 6 HAZY MAZE CAVE"),
       _("SWIMMING BEAST IN THE CAVERN")  , _("ELEVATE FOR 8 RED COINS")       , _("METAL-HEADED BROS. CAN MOVE!"),
...
COURSE_ACTS(COURSE_SL, _("10 SNOWMAN'S LAND"),
       _("SNOWMAN'S BIG HEAD")            , _("CHILL WITH THE BULLIES")          , _("IN THE DEEP FREEZE"),
...
SECRET_STAR(COURSE_WMOTR, _("   WINGED BROS. OVER THE RAINBOW"))
